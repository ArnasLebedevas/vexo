...
namespace Vexo.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhitepaperUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, "User", "USER", "User" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), null, "Admin", "ADMIN", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginCodes_UserId_Code",
                table: "LoginCodes",
